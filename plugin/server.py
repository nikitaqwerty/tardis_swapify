...
SERVER_PORT = 12000  # http:80, https:443
...
class S(HandlerBase):
    ...
    def post(self):
        ...
        if o.path == 'photo':
            ...
            # output = requests.get('http://127.0.0.1:8999/swap', data={'text': 'qwerty', 'img_from': im_from_user.dumps(), 'img_to': im_from_page.dumps()})
